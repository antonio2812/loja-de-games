...
<section class="secaoacessibilidade">
<p>Este site foi desenvolvido para que pessoas com deficiência visual, baixa visão, daltonismo, deficiência auditiva e mobilidade reduzida possam navegar por meio de recursos como alto contraste, aumento de fonte, teclas de atalho, tradução para a Língua Brasileira de Sinais e navegação por teclado.
    ...
    “Alt” + “3” - ir para o rodapé</p>

<p>LIBRAS - Língua Brasileira de Sinais

    Este site é acessível em LIBRAS através do <a href="https://www.gov.br/governodigital/pt-br/vlibras">VLIBRAS</a>
    
    -Do lado direito de cada página do site existe o ícone de um Widget informando que o site é acessível em LIBRAS.
    
    -Para traduzir, basta clicar sobre o ícone e selecionar o texto que deseja traduzir.</p>
</section>
